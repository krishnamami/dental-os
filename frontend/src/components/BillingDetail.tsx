...
const NOTIFY: Record<Owner, string> = {
  billing: "",
...
function Group({
  ...
  owner: Owner;
  items: Condition[];
  onAct: (c: Condition, action: string) => void;
}) {
              ...
              <li key={c.signal_code} className="px-4 py-3">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    onAct(c, mine ? "resolved" : "notified");
                  }}
            ...
            <div className="mt-4 space-y-3">
              <section className="rounded-xl border border-gray-200 bg-white p-5">
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <Field
                    label={
                      createdAt ? "Payer deadline" : "Payer deadline (unknown)"
                    }
                    value={
