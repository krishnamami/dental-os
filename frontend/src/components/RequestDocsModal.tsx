...
export default function RequestDocsModal({
  ...
  patientName: string;
  onClose: () => void;
  onSend: (documents: string[], note: string) => void;
}) {
    ...
    >
      ...
      >
        ...
        <p className="mt-3 text-[11px] leading-relaxed text-gray-400">
          Demo only — nothing is sent and no record is written. There is no
          document-request endpoint yet.
        </p>
      </div>
    </div>
  );
