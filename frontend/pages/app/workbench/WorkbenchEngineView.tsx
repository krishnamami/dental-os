...
import { formatCurrencyShort, greetingFor } from "../../../utils/format";
    ...
    <div className="md:flex md:h-[calc(100dvh-49px)] md:overflow-hidden">
      ...
      >
        <div className="border-b border-gray-200 px-3 py-3.5">
          {/* Both of these were literals. Kim reads this screen too,
              and Tampa's clinical lead is Dr. Rodriguez — a hardcoded
              name and practice greet the wrong person at the wrong
              practice. */}
          <p className="text-[14px] font-semibold text-gray-900">
            {greetingFor(effectiveUser?.name)}
          </p>
          <p className="mt-0.5 text-[12px] text-gray-500">
            {effectiveUser?.tenant_name ?? "Accord Dental"} · {action.length}{" "}
            need action
          </p>
