...
const BLOCKING = new Set([
  ...
  "PRED_BLOCKED_FRAUD", // pre-rename alias
...
export function toneFor(signal: Signal): SignalTone {
  // Both prefixes: INTEGRITY_ is the current name, FRAUD_ still
  // appears in any bundle written before the rename.
  if (
    BLOCKING.has(signal.signal_code) ||
    signal.signal_code.startsWith("INTEGRITY_") ||
    signal.signal_code.startsWith("FRAUD_")
  ) {
    return "red";
  }
