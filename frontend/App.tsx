        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<AppShell />}>
            ...
            <Route element={<ProductRoute product="portfolio" />}>
              ...
              <Route path="/dso/causes" element={<DSOIntelligence />} />
              <Route path="/dso/payers" element={<DSOIntelligence />} />
              {/* The previous tab paths. Kept as routes rather than
                  deleted: they are in bookmarks and in the last
                  deploy's markup, and the component maps each to its
                  nearest surviving tab. /dso/revenue restated the
                  header and /dso/training invented a recommendation
                  from a single snapshot; both are gone. */}
